...
topDir=/data/projects/mdc-971/data_from_Jan_2020/analysis
inDir=/data/projects/mdc-971/data_from_Jan_2020/analysis/40.aligned_with_STAR
outDir=$topDir/45.featureCounts_STAR_mapped

featureCounts -a $outDir/reference.saf \
	-o $outDir/counts.txt \
	-F SAF \
	-p \
	-C \
