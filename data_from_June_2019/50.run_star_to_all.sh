...
for i in /data/projects/mdc-971/data_from_June_2019/30.primer_trimmed/*_cutadapt.1.fq.gz
do
	f=$(basename $i)
	dir="/data/projects/mdc-971/data_from_June_2019/50.aligned_to_L1_HBB/${f%.*}.dir/"
	mkdir "$dir"
